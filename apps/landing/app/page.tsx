...
import ApiSnippetSection from "../components/api-snippet-section"
...
export default function LandingPage() {
  ...
  const startTour = useStartLandingTour()
  ...
  const getDashboardContent = () => {
    switch (activeCard) {
      case 0:
        return <div className="text-[#828387] text-sm">Onboarding flow — step-by-step user guidance</div>
      case 1:
        return <div className="text-[#828387] text-sm">Feature discovery — contextual highlights</div>
      case 2:
        return <div className="text-[#828387] text-sm">Release highlights — in-product announcements</div>
      default:
        return <div className="text-[#828387] text-sm">Onboarding flow — step-by-step user guidance</div>
    }
  }
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                <div className="flex justify-center items-center">
                  ...
                  <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 flex justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                    ...
                    <div className="flex justify-start items-center">
                      <a href="#api" className="flex flex-col justify-center text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium leading-[14px] font-sans hover:text-[#37322F] transition-colors">
                        API
                      </a>
                    </div>
                    <div className="flex justify-start items-center">
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  ...
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    FlowPilot is a headless React library for in-product flows.
                    <br className="hidden sm:block" />
                    You own the UI. We own the state.
                  </div>
                </div>
              </div>
              ...
              <div className="w-full max-w-[497px] lg:w-[497px] flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 relative z-10 mt-6 sm:mt-8 md:mt-10 lg:mt-12">
                <div className="backdrop-blur-[8.25px] flex justify-start items-center gap-4">
                  ...
                  <a
                    href="#api"
                    className="h-10 sm:h-11 md:h-12 px-6 sm:px-8 md:px-10 py-2 sm:py-[6px] rounded-full border border-[rgba(55,50,47,0.20)] flex justify-center items-center cursor-pointer hover:bg-[rgba(55,50,47,0.04)] transition-colors"
                  >
                    <span className="text-[#37322F] text-sm sm:text-base md:text-[15px] font-medium leading-5 font-sans">View docs</span>
                  </a>
                </div>
              </div>
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  ...
                  <FeatureCard
                    ...
                    description="FlowPilot manages state and sequencing. You render exactly what your design system requires."
                    isActive={activeCard === 0}
                    progress={activeCard === 0 ? progress : 0}
                    onClick={() => handleCardClick(0)}
                  />
                  <FeatureCard
                    title="Target-based steps"
                    description="Point each step at any CSS selector, data attribute, or React ref. Resolution happens at runtime."
                  ...
                  <FeatureCard
                    title="Events & hooks"
                    description="React to every step transition with typed events and the useFlowPilot hook — no polling required."
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Used in production across onboarding, feature discovery,
                      <br className="hidden sm:block" />
                      and contextual guidance workflows.
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="w-full max-w-[598.06px] lg:w-[598.06px] text-center flex justify-center flex-col text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
                      Everything a tour library should be
                    </div>
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Composable primitives. Predictable state.
                      <br />
                      Zero forced UI opinions.
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    ...
                    <div className="border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Define every step as a plain object. Compose flows from parts of your app without touching component code.
                        </p>
                      </div>
                    ...
                    <div className="border-b border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Manage step state yourself or let FlowPilot own it. Both modes share the same event and hook surface.
                        </p>
                      </div>
                    ...
                    {/* Bottom Left - Framework agnostic */}
                    <div className="border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 bg-transparent">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Works with Next.js, Remix, Vite, and any SSR framework. No window access during server render.
                        </p>
                      </div>
                    ...
                    <div className="p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          No hidden CSS, no animation runtime. You only ship the UI components you choose to render.
                        </p>
                      </div>

        ...
        <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[56px] font-sans tracking-tight">
              Ship your first guided tour today.
            </div>
            <div className="self-stretch text-center text-[#605A57] text-base leading-7 font-sans font-medium">
              Install FlowPilot, define a flow, and render it with your own UI.
              <br />
              No lock-in. No hidden UI. Just the right abstraction.
            </div>
          </div>
          <div className="w-full max-w-[497px] flex flex-col justify-center items-center gap-12">
            <div className="flex justify-start items-center gap-4">
              ...
              <a
                href="#api"
                className="h-10 px-6 py-[6px] rounded-full border border-[rgba(55,50,47,0.20)] flex justify-center items-center cursor-pointer hover:bg-[rgba(55,50,47,0.04)] transition-colors"
              >
                <span className="text-[#37322F] text-[13px] font-medium leading-5 font-sans">View API docs</span>
              </a>
            </div>
          </div>
        </div>

...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "FlowPilot gave us complete control over the tour UI without rewriting state management. We slotted it into our design system in a single afternoon.",
      name: "Jamie Marshall",
      company: "Staff Engineer, Exponent",
      image: "/testimonial-avatar-1.jpg",
    },
    {
      quote:
        "We tried three tour libraries before FlowPilot. None of them let us use our own components. FlowPilot is the only headless option that actually works at scale.",
      name: "Sarah Chen",
      company: "Frontend Lead, TechFlow",
      image: "/testimonial-avatar-2.jpg",
    },
    {
      quote:
        "The controlled-mode API made it trivial to tie guided tours into our analytics pipeline. Every step transition fires exactly the events we need.",
      name: "Marcus Rodriguez",
      company: "Principal Engineer, InnovateCorp",
